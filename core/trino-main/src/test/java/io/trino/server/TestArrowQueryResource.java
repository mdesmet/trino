...
public class TestArrowQueryResource
{
            ...
            throws Exception
    {
        ...
        assertArrowResult(sql, ImmutableList.of("""
                    ...
                    4   1369    O   56000.919414    5-LOW   Clerk#000000124 0   sits. slyly regular warthogs cajole. regular, regular theodolites acro
                    ...
                    33  670 F   146567.24   8700    3-MEDIUMClerk#000000409 0   uriously. furiously final request
            ...
            throws Exception
    {
        ...
        List<byte[]> decodedChunks = input.stream().map(s -> Base64.getDecoder().decode(s.getBytes(UTF_8))).toList();
