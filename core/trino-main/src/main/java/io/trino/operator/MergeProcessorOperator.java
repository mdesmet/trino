        ...
        implements WorkProcessorOperator
{
    ...
    {
        RowChangeProcessor rowChangeProcessor = createRowChangeProcessor(merge, rowIdChannel, mergeRowChannel, redistributionColumns, dataColumnChannels);
        return createAdapterOperatorFactory(new Factory(operatorId, planNodeId, rowChangeProcessor));
    }

    private static RowChangeProcessor createRowChangeProcessor(MergeParadigmAndTypes merge, int rowIdChannel, int mergeRowChannel, List<Integer> redistributionColumnChannels, List<Integer> dataColumnChannels)
    {
