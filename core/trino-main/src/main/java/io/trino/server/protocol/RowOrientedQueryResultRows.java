...
public class RowOrientedQueryResultRows
        implements QueryResultRows
{
    ...
    private RowOrientedQueryResultRows(Session session, Optional<List<ColumnAndType>> columns, List<Page> pages, Consumer<Throwable> exceptionConsumer)
    {
    ...
    public static RowOrientedQueryResultRows empty(Session session)
    {
    ...
    public static class Builder
    {
        ...
        public RowOrientedQueryResultRows build()
        {
            return new RowOrientedQueryResultRows(
                    session,
                    columns,
                    pages.build(),
                    exceptionConsumer);
            ...
            extends AbstractIterator<List<Object>>
    {
        ...
        private final RowOrientedQueryResultRows results;
        private Page currentPage;
        private int rowPosition = -1;
        private int inPageIndex = -1;

        public ResultsIterator(RowOrientedQueryResultRows results)
        {
